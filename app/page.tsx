...
const T = {
  ...
  grainSrc:      "black",
  ambient:       [
    "radial-gradient(ellipse 55% 70% at 22% 42%, rgba(0,158,133,0.06) 0%, transparent 60%)",
    "radial-gradient(ellipse 45% 55% at 78% 68%, rgba(200,90,26,0.04) 0%, transparent 55%)",
    "radial-gradient(ellipse 30% 40% at 55% 12%, rgba(0,130,180,0.03) 0%, transparent 50%)",
  ].join(", "),
  eyebrow:       "#009E85",
  titleBase:     "#1A1612",
  titleAccent:   "#009E85",
  ...
  featureBorder: "rgba(26,22,18,0.18)",
  featureBg:     "rgba(26,22,18,0.07)",
  teal:          "#009E85",
  ...
  shadowA:       "rgba(26,22,18,0.15)",
  shadowB:       "rgba(26,22,18,0.08)",
  fadeSolid:     "#FFFFFF",
  fadeMid:       "rgba(255,255,255,0.55)",
};
    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          style={{ fontFamily: "var(--font-cormorant)", fontWeight: 300, fontSize: "clamp(3.2rem, 5.6vw, 6.2rem)", lineHeight: 0.9, letterSpacing: "-0.02em", color: T.titleBase, marginBottom: "2.25rem", whiteSpace: "nowrap" }}
        >
          Straight<em style={{ fontStyle: "italic", color: T.titleAccent, letterSpacing: "-0.03em" }}>line</em>
        </motion.h1>
        ...
        <motion.div
          ...
          style={{ display: "flex", alignItems: "center", gap: "1.75rem", width: "100%" }}
        >
          <a
            href="/map"
            aria-label="Open the map to explore a location"
            style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.7rem", padding: "1rem 2rem", background: T.teal, color: T.tealBtnText, fontFamily: "var(--font-geist-mono)", fontSize: "0.8rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", textDecoration: "none", borderRadius: "3px", transition: "transform 0.18s ease, box-shadow 0.18s ease", width: "100%" }}
        ...
        {FRAMES.map((frame, i) => {
          ...
          return (
            <div
              ...
              style={{ position: "absolute", left: `${cfg.x}%`, top: 0, width: cfg.w, willChange: "transform", transformOrigin: "center center", background: T.cardBg, borderRadius: "2px", boxShadow: `0 14px 52px ${T.shadowA}, 0 4px 12px ${T.shadowB}`, overflow: "hidden", userSelect: "none", zIndex: 2 }}
            >
